...
// sections
import { UserListHead, UserListToolbar } from '../sections/@dashboard/teknisi';
// mock
import ModalUpdate from '../sections/@dashboard/teknisi/UserModalUpdate';
import ModalPostButton from '../sections/@dashboard/teknisi/UserModalPost';
import ModalDeleteButton from '../sections/@dashboard/teknisi/UserModalDelete';
// ----------------------------------------------------------------------
...
export default function UserPage() {
  ...
  useEffect(() => {
    const fetchPelanggan = async () => {
      try {
        ...
        const response = await fetch('http://127.0.0.1:3000/teknisi', { headers });
        if (!response.ok) {
  ...
  const DeletePelanggan = (id) => {
    ...
    axios
      .delete(`http://127.0.0.1:3000/teknisi/${id}`, { headers })
      .then((res) => {
        console.log(res);
  ...
  const UpdatePelanggan = (id, updatedData) => {
    const token = Cookies.get('token');
    axios
      .put(`http://127.0.0.1:3000/teknisi/${id}`, updatedData, { headers: { Authorization: `Bearer ${token}` } })
      .then((res) => {
        console.log(res);
        console.log(token);
        console.log(res.data);
